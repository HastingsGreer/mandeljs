...
void main() {
  ...
  `),q={program:y,attribLocations:{vertexPosition:o.getAttribLocation(y,"aVertexPosition")},uniformLocations:{projectionMatrix:o.getUniformLocation(y,"uProjectionMatrix"),modelViewMatrix:o.getUniformLocation(y,"uModelViewMatrix"),state:o.getUniformLocation(y,"uState"),poly1:o.getUniformLocation(y,"poly1"),poly2:o.getUniformLocation(y,"poly2")}},M=f(o),E=o.createTexture();o.bindTexture(o.TEXTURE_2D,E),o.texParameteri(o.TEXTURE_2D,o.TEXTURE_MIN_FILTER,o.NEAREST),o.texParameteri(o.TEXTURE_2D,o.TEXTURE_MAG_FILTER,o.NEAREST),o.pixelStorei(o.UNPACK_ALIGNMENT,1),e.callbacks.unshift(()=>{F(o,q,M)}),e.modified()}function f(r){const n=r.createBuffer();r.bindBuffer(r.ARRAY_BUFFER,n);const c=[1,1,-1,1,1,-1,-1,-1];return r.bufferData(r.ARRAY_BUFFER,new Float32Array(c),r.STATIC_DRAW),{position:n}}function v(){for(var r=e.center[0],n=e.center[1],c=s(),o=s(),l=new Float32Array(512*512),_=0;_<512*512;_++)l[_]=-1;for(var y=s(),q=s(),M=s(),E=0,i=0,a=0,d=0,p=0,x=0,h=0,k=[0,0,0,0,0,0],T=!0,_=0;_<e.iterations;_++){var P=t.mpfr_get_exp(c),U=t.mpfr_get_exp(o),L=Math.max(P,U);L<-1e4&&(L=0),l[3*_]=t.mpfr_get_d(c,0)/Math.pow(2,L),l[3*_+1]=t.mpfr_get_d(o,0)/Math.pow(2,L),l[3*_+2]=L;var S=t.mpfr_get_d(c,0),w=t.mpfr_get_d(o,0);t.mpfr_mul(y,c,c,0),t.mpfr_mul(q,c,o,0),t.mpfr_mul(M,o,o,0),t.mpfr_sub(c,y,M,0),t.mpfr_add(c,c,r,0),t.mpfr_add(o,q,q,0),t.mpfr_add(o,o,n,0);var D=[i,a,d,p,x,h];if([i,a,d,p,x,h]=[2*(S*i-w*a)+1,2*(S*a+w*i),2*(S*d-w*p)+i*i-a*a,2*(S*p+w*d)+2*i*a,2*(S*x-w*h+d*i-p*a),2*(S*h+w*x+d*a+p*i)],S=t.mpfr_get_d(c,0),w=t.mpfr_get_d(o,0),Math.max(Math.abs(d),Math.abs(p))>=100*t.mpfr_get_d(e.radius,0)*Math.max(Math.abs(x),Math.abs(h))?T&&(k=D,E=_):T=!1,S*S+w*w>400)break}return console.log("orbit_len",_),console.log("plim",E),[l,k,E]}function F(r,n,c){for(var[o,l,_]=v(),y=new Float32Array(o),q=2,M=2;M<o.length;M++)q=Math.min(q,Math.abs(o[M]));console.log("smallest orbit bit",q),r.texImage2D(r.TEXTURE_2D,0,r.R32F,512,512,0,r.RED,r.FLOAT,y),r.clearColor(0,0,0,1),r.clearDepth(1),r.enable(r.DEPTH_TEST),r.depthFunc(r.LEQUAL),r.clear(r.COLOR_BUFFER_BIT|r.DEPTH_BUFFER_BIT);let E,i;[E,i]=g(r);{const x=2,h=r.FLOAT,k=!1,T=0,P=0;r.bindBuffer(r.ARRAY_BUFFER,c.position),r.vertexAttribPointer(n.attribLocations.vertexPosition,x,h,k,T,P),r.enableVertexAttribArray(n.attribLocations.vertexPosition)}r.useProgram(n.program),r.uniformMatrix4fv(n.uniformLocations.projectionMatrix,!1,E),r.uniformMatrix4fv(n.uniformLocations.modelViewMatrix,!1,i),console.log(t.mpfr_get_exp(e.radius));var a=t.mpfr_get_d(e.radius,0);r.uniform4f(n.uniformLocations.state,e.center[0],e.cmapscale,t.mpfr_get_exp(e.radius),e.iterations),console.log(l);var d=Math.floor(Math.log2(Math.sqrt(l[0]*l[0]+l[1]*l[1]))),p=1/Math.pow(2,d);r.uniform4f(n.uniformLocations.poly1,p*l[0],p*l[1],p*a*l[2],p*a*l[3]),r.uniform4f(n.uniformLocations.poly2,p*a*a*l[4],p*a*a*l[5],_,d),console.log("poly_scaled",a*l[0],a*l[1],a*a*l[2],a*a*l[3],a*a*a*l[4],a*a*a*l[5],_,0);{const x=0,h=4;r.drawArrays(r.TRIANGLE_STRIP,x,h)}}});
